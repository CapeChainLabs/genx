...
import (
	...
	"github.com/capechain/genx/x/creation"
	"github.com/capechain/genx/x/creation/keeper"
	creationtypes "github.com/capechain/genx/x/creation/types"
...
func NewChainApp(
	...
	wasmConfig := wasmtypes.WasmConfig{
		SimulationGasLimit: nil,
		SmartQueryGasLimit: 300_000,
		MemoryCacheSize:    100,
	...
	app.WasmKeeper = wasmkeeper.NewKeeper(
		...
		app.IBCFeeKeeper, // IBC middleware keeper
		app.IBCKeeper.ChannelKeeper,
		app.IBCKeeper.PortKeeper,
		scopedWasmKeeper,
		app.TransferKeeper,
		...
		wasmDir,
		wasmConfig,
		strings.Split(capabilities, ","),
		authtypes.NewModuleAddress(govtypes.ModuleName).String(),
		wasmOpts...,
	)

	app.CreationKeeper = *keeper.NewKeeper(
		appCodec,
		keys[creationtypes.StoreKey],
		app.BankKeeper,
	...
	ibcRouter.AddRoute(wasmtypes.ModuleName, wasm.NewIBCHandler(app.WasmKeeper, app.IBCKeeper.ChannelKeeper, app.IBCFeeKeeper))
	...
	app.ModuleManager = module.NewManager(
		...
		creation.NewAppModule(appCodec, app.CreationKeeper),
	)
	...
	genesisModuleOrder := []string{
		...
		poa.ModuleName,
		tokenfactorytypes.ModuleName,
		// wasm module should be at the end as it can call other module functionality
		wasmtypes.ModuleName,
		creationtypes.ModuleName,
	}
	...
	// see cmd/genxd/root.go: 206 - 214 approx
	...
	if loadLatest {
		...
		// Initialize pinned codes in wasm module
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(creationtypes.ModuleName)
